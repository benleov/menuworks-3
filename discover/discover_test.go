...
func TestRenderConfigMultiSourceCategory(t *testing.T) {
	...
	apps := []DiscoveredApp{
		{Name: "Half-Life 2", Exec: "start steam://rungameid/220", Source: "steam", Category: "Games"},
		{Name: "Portal 2", Exec: "start steam://rungameid/620", Source: "steam", Category: "Games"},
		{Name: "Minecraft", Exec: `explorer.exe shell:AppsFolder\Microsoft.MinecraftUWP_8wekyb3d8bbwe!Minecraft`, Source: "xbox", Category: "Games"},
	}
...
func TestEndToEndMultiSourceGames(t *testing.T) {
	...
	r.Register(&mockSource{
		...
		available: true,
		apps: []DiscoveredApp{
			{Name: "Minecraft", Exec: `explorer.exe shell:AppsFolder\MC!Game`, Source: "xbox", Category: "Games"},
		},
	})
	r.Register(&mockSource{
		name:      "startmenu",
